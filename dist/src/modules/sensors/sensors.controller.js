...
let SensorsController = class SensorsController {
    ...
    async registerBlower(body) {
        const config = await this.sensorsService.registerBlower(body.tenantId, body.blowerId);
        return {
...
__decorate([
    (0, common_1.Post)('register-blower'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SensorsController.prototype, "registerBlower", null);
